...
Write-Host ""
Write-Host "Do not upload host-local/generated directories:"
Write-Host "  .git, .idea, .venv-benchmark, docker/generated"
Write-Host "  docker/forl0-local.env (the server regenerates it)"
Write-Host ""
Write-Host "IMPORTANT: upload into an empty target directory, or enable deletion of"
Write-Host "remote files absent from the local tree. Plain overwrite leaves stale"
Write-Host "results and host-local environment files on the server."
Write-Host ""
